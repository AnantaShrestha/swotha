...
class AgencyController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		[
			...
			'companyname.max'=>'The Company Name may not be greater than 50 characters',
			'registration_number'=>'Registration Number is required',
			'registration_number'=>''*/
			'acity.required'=>'The city field is required',
			'apostalcode.required'=>'The postal code is required',
			'ampassword.required'=>'The password field is required',
			'ampassword.min'=>'The password must be at least 6 character',
			'amconfirmPassword.required'=>'The confirm password field is required',
			'amconfirmPassword.min'=>'The confirm password must be at least 6 character',
			'amconfirmPassword.same'=>'The confirm password and password must match',
			'agencypublicphone'=>'The agency public phone field is required',
			'agencypublicphone'=>'The agency public phone is already taken',
			'aphonenumber.required'=>'The phone number field is required',
			'aphonenumber.unique'=>'The phone number is already taken',
			'amfirstname.required'=>'The first name field is required',
			'amlastname.required'=>'The last name field is required',
			'amemail.required'=>'The email field is required',
			'amemail.unique'=>'The email is already taken'
		]
		...
		$notification = array(
			'message' => 'Thank you for your registration! A verification link has been sent to your email address: '.$user->email,
			'alert-type' => 'success',
		);
