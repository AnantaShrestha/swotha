...
class ThreeBookController extends Controller
{
    public function showform(Request $request)
    {
        ...
        return view('frontend.newbooking.customtrip.customtripbook', compact('trips', 'invoiceNo', 'allequipments', 'extrapackages', 'countries', 'manche', 'totalprice', 'extracharge'));
    ...
    public function savealldata(Request $request)
    {
        ...
        $data = array(
            ...
            'booking' => $booking, 'gdiscount' => $gdiscount, 'sdiscount' => $sdiscount, 'customprice' => $customprice,
