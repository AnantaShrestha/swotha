...
@section('title')
    {{$city->name}} | Swotah Travel and Adventure
@endsection
@section('metatags')
    {{--Here goes all the meta information for index page--}}
    <meta name="title" content="{{$city->name}} | Swotah Travel and Adventure">
    ...
    <link rel="canonical" href="{{route('show-path',$city->slug)}}">
...
@section('content')
    ...
    <div class="Modern-Slider">
        <div class="inner-bg-img" style="  background:url('{{url('images/tripPackages/cover/'.$city->image)}}');background-size:cover;background-repeat: no-repeat;">
...
@endsection
@section('scripts')
    <script src="{{asset('js/plugin/bucket.js')}}"></script>
