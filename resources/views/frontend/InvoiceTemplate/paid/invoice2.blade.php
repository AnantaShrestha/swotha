...
<div class="container" style="background-color: white;margin-top: -15px!important;
    ...
    <div class="row">
        ...
        @if($payment->chosen == 'fullpayment')
            <h4 style="font-size: 13px;font-weight: bolder;
        color:#0c0f96; padding: 2px 3px;
                ...
                <div>
                    ...
                    <table class="table table-bordered" id="payementTable" style="position:relative;">
                        ...
                        <tr>
                            ...
                            <td>{{$tripbooking->people}}</td>
                            <td>USD $<?php $triptotal = $customprice;
                            echo $triptotal?> </td>
                        </tr>
                        <tr>
                            <td><b>Discounts</b>
