...
<div class="container" style="background-color: white;margin-top: -15px!important;
    ...
    <div class="row">
        ...
        <h4> <span style="font: 15px bold;background: #008EB0;color: white;padding: 5px 10px;text-align: center;position:absolute; top:-1px;right:10px;letter-spacing: 2px;"> FULL PAID </span></h4>
         @else
         <h4> <span style="font: 15px bold;background: #008EB0;color: white;padding: 5px 10px;text-align: center;position:absolute; top:-1px;right:10px;letter-spacing: 2px;"> ADVANCED PAID </span></h4>
        @endif
    </div>
