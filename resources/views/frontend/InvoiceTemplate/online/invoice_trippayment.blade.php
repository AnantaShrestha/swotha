...
<div class="container" style="background-color: white;margin-top: -15px!important;
    ...
    <div class="row">
        ...
        <h4> <span style="font: 15px bold;background: #008EB0;color: white;padding: 5px 10px;text-align: center;position:absolute; top:-1px;right:10px;letter-spacing: 2px;"> FULL PAID </span></h4>
    </div>
        ...
        <div class="row">
            <div id="logoAndCompInfo">
                <div class="col-xs-6" >
                    ...
                    <p>Email : info@swotahtravel.com, aj@swotahtravel.com</p>
                </div>
                ...
                <div>
                    ...
                    <table class="table table-bordered" id="payementTable" style="position:relative;">
                        ...
                        <tr>
                            ...
                            <td>{{$tripbooking->people}}</td>
                            <td>USD $<?php echo $trip->price * $tripbooking->people ?></td>
                        </tr>
                        <tr>
                            <td><b>Discounts</b>
                            ...
                            <td>
								...
								$totaldiscount = round(($trip->price - $tripP),2);

								echo "USD $".$totaldiscount;
								?>
                            </td>
                            <td>{{$tripbooking->people}}</td>
                            <td>(USD ${{($totaldiscount * $tripbooking->people )}} )</td>
                        </tr>
                        @if($disamo != null)
                            <tr>
                                <td colspan="3">Promo Code Discount: <?php $copondiscount = $disamo; ?></td>
                                <td>(USD ${{$copondiscount}})</td>
                            </tr>
                        @else  <?php $copondiscount = 0; ?> @endif
                        @if($payment->status == "halfpaid")
                            <tr>
                                <td colspan="3">Advance Payment</td>
                                <td>(USD $ {{$payment->paid_amount_sum}})</td>
                            </tr>
                        @endif
                        </tbody>
                        <tfoot>
                        <tr style="color: #0C9B8E;">
                            ...
                            <td>
                                @if($payment->status != "halfpaid")
                                    <?php $grandtotal =  (($trip->price - $totaldiscount)* $tripbooking->people)  - $copondiscount; ?>
                                <b>USD $ {{(($trip->price - $totaldiscount)* $tripbooking->people)  - $copondiscount  }}</b>
                                @else
                                    <?php $grandtotal = (($trip->price - $totaldiscount)* $tripbooking->people)  - $copondiscount - $payment->paid_amount_sum; ?>
                                <b>USD $ {{(($trip->price - $totaldiscount)* $tripbooking->people)  - $copondiscount - $payment->paid_amount_sum }}</b>
                                @endif
                            </td>
                        </tr>
                        </tfoot>
                ...
                <table class="table " id="grandTotal"  style="border: 1px solid lightgray">
                    <tr style="color: #b71c1c;">
                        <td  style="text-align: right;">
                            ...
                            &nbsp;&nbsp;&nbsp;
                            <b><span style="font-size: 15px;">USD $ {{round($payment->left_amount_sum)}}</span>
                                (
            ...
            <div class="col-xs-12" style="margin-top: -15px;margin-bottom: -15px;">
                <table class="table table-bordered" id="confirmandDue" >
                    ...
                    <tr>
                        ...
                        <td>
                            <b>USD $ {{round($payment->left_amount_sum)}}</b>
                        </td>
                        <td >
                            <b >Due Amount:</b>
                        </td>
            ...
            <div class="col-xs-4" style="margin-top: -15px;">
                <div style=" border: 1px solid lightgray;padding:0px;">
                    <table  id="stampAndSign" style="margin-left:15%; margin-top:-4%;">
                        ...
                        <tr>
                            <td >
                                <img src="https://i.imgur.com/Wxd7a1u.png"
