                ...
                <div>
                    ...
                    <table class="table table-bordered" id="payementTable" style="position:relative;">
                        ...
                        <tr>
                            ...
                            <td>{{$booking->people}}</td>
                            <td>USD $<?php echo $tripdate->price * $booking->people ?></td>
                        </tr>
                        <tr>
                            <td><b>Discounts</b>
                            ...
                            <td>{{$booking->people}}</td>
                            <td>(USD ${{($totaldiscount * $booking->people)}} )</td>
                        </tr>
                        @if($disamo != null)
                            <tr>
                        ...
                        <tr style="color: #0C9B8E;">
                            ...
                            <td>
                                @if($payment->status != "halfpaid")
			                        <?php $grandtotal =  (($trip->price - $totaldiscount)* $booking->people)  - $copondiscount; ?>
                                    <b>USD $ {{(($trip->price - $totaldiscount)* $booking->people)  - $copondiscount  }}</b>
                                @else
			                        <?php $grandtotal = (($trip->price - $totaldiscount)* $booking->people)  - $copondiscount - $payment->paid_amount_sum; ?>
                                    <b>USD $ {{(($trip->price - $totaldiscount)* $booking->people)  - $copondiscount - $payment->paid_amount_sum }}</b>
                                @endif
                            </td>
                        </tr>
                        </tfoot>
