...
@section('content')
    ...
    <div class="container containerPadding center-align" style="margin-top:60px;">
        <h2 class="titleHeadtwo"><span class="reviewTitle">Swotah Travel and Adventure [Online payment] </span></h2>
        <div class="card" style="padding:10px 30px;">
            <form name="myForm" id="myForm" action="/processpay" method="post">
                ...
                <div class="row">
                    ...
                    <div class="input-field col l6 m6 s12">
                        <input name="tripdescription" type="text" class="validate" required>
                ...
                <div class="row">
                    <div class="input-field col l6 m6 s12">
                        <input id="startdate" type="date"
                               name="startdate" class="datepicker" required>
                        <label for="startdate" data-error="fill in the date"><b>Trip Date</b></label>
                    </div>
                    <div class="input-field col l6 m6 s12">
                        <input name="amount" type="number" class="validate" min="1" required>
