                    ...
                    <div class='form-field-block'>
                        <form id="firstform" action="/tripbook-confirm" method="post">
                            ...
                            <div class="info-form">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6">
                                                <div class="form-group">
                                                    ...
                                                    <select id="not" name="not" class="form-control col-4-select"
                                                            required>
                                                        <option value="{{$trips->min_group_size}}" selected>No of
                                                            Travellers :{{$trips->min_group_size}}</option>
                                                        @for($z = $trips->min_group_size+1; $z <= 14; $z ++)
                                                            <option {{ old('not') == $z ? "selected" : "" }} value="{{$z}}">
                                                                No of Travellers :{{$z}}</option>
                                                            @endfor</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{old('startdate')}}" type="date" id="startdate"
                                ...
                                <fieldset id="rentalfield" class="all-body">
                                    ...
                                    <input type="button" name="next" class="next top-sc action-button" value="Next"/>
                                </fieldset>
                                <fieldset id="general">
...
@section('scripts')
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
        ...
        var min_total_people = "{{$trips->min_group_size}}";
