            ...
            <div class="row">
                <div class="col-lg-7 col-md-7 col-sm-12 pl-0 pr-0 mesureheight">
                    ...
                    <div class='form-field-block'>
                        <form id="firstform" action="/book-confirm" method="post">
                            <input type="hidden" name="invoiceno" value="{{$invoiceNo}}">
                            <input type="hidden" name="tripid" value="{{$tripdate->trips->id}}">
                            <div class="info-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6">
                                            ...
                                            <select id="not" name="not" class="form-control col-4-select" required>
                                                <option value="{{$tripdate->trips->min_group_size}}" selected>No of
                                                    Travellers :{{$tripdate->trips->min_group_size}}</option>
                                                @for($z = $tripdate->trips->min_group_size+1; $z <= 14; $z ++)
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6">
                                            ...
                                            <!--  <input type="date" id="startdate" name="start_date"  class="form-control"
                                             required> -->
                                            <input id="date startdate" class="form-control" name="date" type="text"
                                                   value="{{date('j F, Y',strtotime($tripdate->start_date))}}" readonly
                                                   placeholder="Trip Departure Date">
                            ...
                            <div class='rental-services'>
                                ...
                                @include('frontend.newbooking.layouts.viewinvoicemodal',[$trips=$tripdate->trips])
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td><b>Location</b><i
                                                        style="font-size:12px;color:#fc0;float:right;line-height:20px"
                                                        class="fa fa-arrow-right" aria-hidden="true"></i></td>
                                            <td>&nbsp;&nbsp;{{$tripdate->trips->start_location}}
                                                - {{$tripdate->trips->finish_location}}</td>
                                        </tr>
                                        <tr>
                                            <td><b>Ages</b><i
                                                        style="font-size:12px;color:#fc0;float:right;line-height:20px"
                                                        class="fa fa-arrow-right" aria-hidden="true"></i></td>
                                            <td>&nbsp;&nbsp;Min {{$tripdate->trips->ages}}</td>
                                        </tr>
                                        <tr>
                                            <td><b>Venture</b><i
                                                        style="font-size:12px;color:#fc0;float:right;line-height:20px"
                                                        class="fa fa-arrow-right" aria-hidden="true"></i></td>
                                            <td>&nbsp;&nbsp;{{$tripdate->trips->ventures}}</td>
                                        </tr>
                                        <tr>
                                            <td><b>Duration</b><i
                                                        style="font-size:12px;color:#fc0;float:right;line-height:20px"
                                                        class="fa fa-arrow-right" aria-hidden="true"></i></td>
                                            <td>&nbsp;&nbsp;{{$tripdate->trips->trekdays}} Days
                                                - {{$tripdate->trips->days}} Days
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><b>Difficulty</b><i
                                                        style="font-size:12px;color:#fc0;float:right;line-height:20px"
                                                        class="fa fa-arrow-right" aria-hidden="true"></i></td>
                                            <td>&nbsp;&nbsp;@if($tripdate->trips->physical_rating == 1)
                                                    Easy
                                                @elseif($tripdate->trips->physical_rating == 2)
                                                    Moderate
                                                @elseif($tripdate->trips->physical_rating  == 3)
                                                    Hard
                                                @elseif($tripdate->trips->physical_rating  == 4)
                                                    Very Hard
                                                @elseif($tripdate->trips->physical_rating  == 5)
                                                    Severe
                                                @elseif($tripdate->trips->physical_rating  == 6)
                                                    Very Severe
                                                @else
                                                    Extreme
                                                @endif</td>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td><b>Trip Departure Date</b><i
                                                        style="font-size:12px;color:#fc0;float:right;line-height:20px"
                                                        class="fa fa-arrow-right" aria-hidden="true"></i></td>
                                            <td>&nbsp;&nbsp;<div id="janedin">{{date('j F, Y',strtotime($tripdate->start_date))}}</div>
                                            </td>
                                        </tr>
                                    </table>
                        ...
                        <div class="package-details-table">
                            ...
                            <table id="package-table-booking" class="highlight grandtotal">
                                ...
                                <tr>
                                    ...
                                    <td>${{$tripdate->trips->price}}</td>
                                    <td><span class="pax">{{$tripdate->trips->min_group_size}}</span></td>
                                    <td>USD $ <span class="triptotal">
                                                {{$tripdate->trips->min_group_size * $tripdate->trips->price}}
                                            </span>
                                    </td>
                                </tr>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var trekdin = "{{$tripdate->trips->trekdays}}";
        var min_total_people = "{{$tripdate->trips->min_group_size}}";
        var trip_price = "{{$tripdate->trips->price}}";
        ...
        function downequip(id) {
            ...
            $('#not').on('change', function () {
                ...
                if (m === true) {
                    var person = formnum;
                    var triprice = "{{$tripdate->trips->price}}";
            ...
            function checkminperson() {
                ...
                var minmanche = "{{$tripdate->trips->min_group_size}}";
                return true;
             ...
             $(document).ready(function () {
                ...
                if (m === true) {
                    var person = $('#not').val();
                    console.log('total people:' + person);
                    var triprice = "{{$tripdate->trips->price}}";
                    var newprice = (person * triprice);
                    $('.pax').html(person);
                    $('.triptotal').html(newprice);
            ...
            function paybank() {
                var formValidate = $('#firstform').valid();
                ...
                if (m === true) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (formValidate) {
                                $('#firstform')[0].setAttribute('action', '/proceedonline');
                                $("#merosubmit").trigger("click");
                            }
                        }
                    });
