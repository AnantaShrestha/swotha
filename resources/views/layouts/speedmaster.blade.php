...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="viewport"
          content="width=device-width, initial-scale=1.0, maximum-scale=0.5, minimum-scale=1.0, user-scalable=no"/>
    ...
    <link rel="shortcut icon"
          href="{{url('https://res.cloudinary.com/images-swotahtravel-com/image/upload/v1531014673/static_images/favicon.ico')}}">
